    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item ${pageContext.request.servletPath == '/capacitacion.jsp' ? 'active' : ''}">
                    <a class="nav-link" href="capacitacion.jsp">Capacitación</a>
                </li>
            </ul>
            <c:if test="${not empty sessionScope.usuario}">
                ...
                <form class="form-inline" action="ServletLogout" method="post">
                    <button class="btn btn-outline-light my-2 my-sm-0 btn-logout" type="submit">Cerrar sesión</button>
                </form>
            </c:if>
        </div>
    </div>
